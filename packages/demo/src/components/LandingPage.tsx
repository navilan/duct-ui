        ...
        <div class="container mx-auto px-6 py-16">
          ...
          <div class="max-w-5xl mx-auto">
            ...
            <div class="bg-base-100/60 backdrop-blur-sm rounded-xl p-8 border border-base-300/50">
              ...
              <div class="mb-8 p-6 bg-primary/10 rounded-lg border border-primary/20">
                ...
                <p class="text-base-content/70 mb-4">
                  Get up and running instantly with a complete starter template including blog, themes, and components.
                </p>
                <div class="flex flex-col sm:flex-row gap-3">
                  ...
                  <div class="text-sm text-base-content/60 flex items-center">
                    Copy <code class="bg-base-300/50 px-2 py-1 rounded text-xs mx-1">packages/starter</code> to start
                  </div>
                </div>
              </div>
