...
function render(props: BaseProps<AppLayoutProps>) {
  ...
  return (
    <div class="h-screen bg-base-100 flex flex-col" {...moreProps}>
      ...
      {/* Footer - part of the flex layout, not fixed */}
      <footer class="bg-base-100 border-t border-base-300 py-4 flex-shrink-0">
        <div class="flex justify-center">
          <div class="flex items-center gap-6">
            <a
              href="/"
              class="text-base-content hover:text-primary transition-colors font-medium"
            >
              Home
            </a>
            <a
            ...
            <a
              ...
              class="text-base-content hover:text-primary transition-colors font-medium flex items-center gap-1"
            >
            ...
            <div class="text-sm text-base-content/60 flex items-center gap-1">
              ...
              <a 
                href="/" 
                class="text-primary hover:text-primary-focus font-semibold"
              >
                Duct UI
              </a>
            </div>
