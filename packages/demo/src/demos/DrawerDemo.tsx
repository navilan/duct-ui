      ...
      >
        <div>
          <div class="space-y-6">
            ...
            <div class="p-6 bg-info-content border border-info/20 rounded-lg">
              <h3 class="text-lg font-medium mb-3 text-info">
                🖥️ Desktop vs Mobile Behavior
              </h3>
              <div class="grid md:grid-cols-2 gap-4 text-sm">
                <div class="space-y-2">
                  <h4 class="font-medium text-info">Desktop (≥1024px):</h4>
                  <ul class="space-y-1 text-info/80">
